...
<head>
    ...
    .box {
        ...
        border-radius: 8px;
        overflow: scroll;
        background-image: url('/assets/skin/grails_logo.png');
    }
    .page-header {
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-links">
            <ul class="nav navbar-nav navbar-right">
                <li class="${actionName.equals("create") ? 'active' : ''}"><g:link controller="person" action="create">
                    Create User</g:link></li>
                <li class="${actionName.equals("show") ? 'active' : ''}"><g:link controller="person" action="show">
                    Show User</g:link> </li>
                <li class="${actionName.equals("list") ? 'active' : ''}"><g:link controller="person" action="list">
                    List Users</g:link> </li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="row">
        ...
        <div class="col-md-2 col-sm-2 col-xs-2">
            <div class="box box-right">
                <h3 class="h3F">D</h3>onate: If you use this site regularly and would like to help keep the site on the Internet,
